...
import com.example.drinkproject.views.CarrelloHolder;
import com.example.drinkproject.views.DrinksHolder;

import controller.Controller;

public class CaricatoreImmaginiCarrello extends AsyncTask<Void, Void, Drawable> {
    private Controller controller;
    private Context context;
    private CarrelloHolder holder;


    public CaricatoreImmaginiCarrello(Controller controller, Context context, CarrelloHolder holder) {
