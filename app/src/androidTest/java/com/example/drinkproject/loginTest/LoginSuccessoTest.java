...
public class LoginSuccessoTest {
        ...
        ViewInteraction appCompatEditText = onView(
                Matchers.allOf(ViewMatchers.withId(R.id.editTextUsername),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("ErPupone"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.editTextPassword),
                        childAtPosition(
                                ...
                                3),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("francesco"), closeSoftKeyboard());
