...
public class BarraDiRicercaTest {
    ...
    @Test
    public void barraDiRicercaTest() {
        ...
        ViewInteraction searchAutoComplete = onView(
                allOf(withClassName(is("android.widget.SearchView$SearchAutoComplete")),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        searchAutoComplete.perform(replaceText("alexa"), closeSoftKeyboard());

        ViewInteraction textView = onView(
                allOf(withId(R.id.nomeDrink), withText("Alexander"),
                        withParent(withParent(withId(R.id.drinkRecyclerView))),
                        isDisplayed()));
        textView.check(matches(withText("Alexander")));
    }
